...
input_image_file_name = "source_images/"+"dirt.jpg"
...
while iterate == True:
    ...
    util.patternROI(looping_image, looping_pixel_map, ROI,0.8, 1) 
    ...
    enhancer = ImageEnhance.Color(looping_image)
    ...
    while True:
        iterate = False
        break
        doAnother = input("Another iteration? (y/n)")
        if doAnother == "y": 
            iterate = True
            break
        elif doAnother == "n":
